...
- Style schemas include `shared/schemas/style-reference.schema.json`,
  `shared/schemas/style-application.schema.json`,
  `shared/schemas/style-patch.schema.json`, and
  `shared/schemas/style-blend.schema.json`.
- Style index and records from `shared/style-references/`.
- Core schema: `shared/schemas/style-reference.schema.json`.
...
- Templates: `shared/templates/style-reference.json`,
  `shared/templates/style-application.json`, `shared/templates/style-patch.json`,
  and `shared/templates/style-blend.json`.
