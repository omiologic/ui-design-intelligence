...
Use `shared/content/laws-of-copywriting.md` when prototype copy needs clearer
...
Use `shared/content/cta-patterns.md` when prototype screens, dialogs, forms,
sticky action regions, disabled states, destructive actions, retries, saves,
continues, or support actions need clear labels.
Use `shared/content/claim-risk-guidelines.md` when prototype copy includes
...
review-flagged.
Use `shared/content/proof-and-credibility-patterns.md` for testimonial, stat,
...
Use `shared/content/microcopy-guidelines.md` for form labels, helper text,
...
restraint.
Use `shared/content/content-accessibility-guidelines.md` when prototype copy
...
Use `shared/content/copy-quality-checklist.md` before handoff to catch missing
...
- Schemas: `shared/schemas/prototype-content.schema.json`,
  `shared/schemas/content-model.schema.json`, and
