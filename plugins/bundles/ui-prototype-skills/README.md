...
```bash
node scripts/install-bundle.mjs install ui-prototype-skills "$HOME/.agents" "$HOME/.agents/skills" --dry-run
node scripts/install-bundle.mjs install ui-prototype-skills "$HOME/.agents" "$HOME/.agents/skills"
```
