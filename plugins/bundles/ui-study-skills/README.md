...
```bash
node scripts/install-bundle.mjs install ui-study-skills "$HOME/.agents" "$HOME/.agents/skills" --dry-run
node scripts/install-bundle.mjs install ui-study-skills "$HOME/.agents" "$HOME/.agents/skills"
```
