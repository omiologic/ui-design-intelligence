...
```bash
node scripts/install-bundle.mjs install ui-seo-skills "$HOME/.agents" "$HOME/.agents/skills" --dry-run
node scripts/install-bundle.mjs install ui-seo-skills "$HOME/.agents" "$HOME/.agents/skills"
```
