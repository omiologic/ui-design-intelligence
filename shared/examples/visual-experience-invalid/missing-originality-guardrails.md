...
| --- | --- | --- | --- | ---: | --- | --- |
| frame | `frame.jpeg` | motion-frame | desktop | 0 | default | success |

## Rendering Layer Ownership

| Region | Layer Owner | Evidence | Confidence | Notes |
| --- | --- | --- | --- | --- |
| Hero | DOM/CSS | screenshot | low | none |

## Design Quality Notes

Missing originality guardrails on purpose.
