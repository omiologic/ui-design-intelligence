...
- `shared/content/laws-of-copywriting.md`: decision sequence, benefit clarity,
  story, proof, objections, and action readiness.
- `shared/content/copy-quality-checklist.md`: pass/fail audit prompts.
- `shared/content/tone-of-voice/tone-of-voice-reference.md`: tone selection and
  phrasing style.
- `knowledge/schemas/copy-pattern.schema.json`: project or domain-specific
  reusable copy patterns.
- `shared/schemas/content-model.schema.json`: page, section, and component copy
  tied to blueprint nodes.
- `shared/schemas/prototype-content.schema.json`: screen, dialog, form, state,
