...
- `shared/content/laws-of-copywriting.md`: checks whether the action has been
...
- `shared/content/content-pattern-library.md`: surrounding page, section, form,
  empty-state, and error-state structures.
- `shared/content/tone-of-voice/tone-of-voice-reference.md`: tone expression
  examples that should preserve the same user intent.
- `shared/schemas/content-model.schema.json`: node-tied CTA fields.
- `shared/schemas/prototype-content.schema.json`: prototype-ready CTA labels,
