...
- `shared/content/tone-of-voice/tone-of-voice-reference.md`: tone choices for
...
- `shared/content/cta-patterns.md`: action labels for primary, secondary,
...
- `shared/content/claim-risk-guidelines.md`: review handling for regulated,
  ...
  claims.
- `shared/content/content-pattern-library.md`: form, empty state, and error
  state structures.
- `shared/schemas/content-model.schema.json`: node-tied component and form copy.
