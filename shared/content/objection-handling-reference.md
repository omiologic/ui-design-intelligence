...
- `shared/content/audience-intent-reference.md`: audience readiness and
  emotional state.
- `shared/content/page-message-architecture.md`: where objections belong in a
  page sequence.
- `shared/content/proof-and-credibility-patterns.md`: proof needed to answer
  trust, risk, comparison, or claim objections.
- `shared/content/claim-risk-guidelines.md`: review handling for regulated,
  pricing, technical, safety, performance, compatibility, and availability
  claims.
- `shared/content/cta-patterns.md`: CTA posture after objections are answered.
...
`shared/content/objection-handling-reference.md` is generic guidance. It
