...
- `.convention/content/microcopy-guidelines.md`: labels, helper text, errors, empty
  states, confirmations, destructive actions, loading, and permission prompts.
- `.convention/content/cta-patterns.md`: button and link label clarity.
- `.convention/content/audience-intent-reference.md`: readiness, emotional state, and
  tone pressure.
- `.convention/content/claim-risk-guidelines.md`: review boundaries for sensitive
  claims.
- `.convention/schemas/content-model.schema.json`: node-tied content roles.
- `.convention/schemas/prototype-content.schema.json`: prototype screen, form,
