...
- `.convention/content/laws-of-copywriting.md`: decision logic, benefit clarity,
  story sequence, proof, objections, and action readiness.
- `.convention/content/tone-of-voice/tone-of-voice-reference.md`: shared tone
  vocabulary, tone fit, sample lines, and tone mixing.
- `.convention/schemas/brand-voice.schema.json`: project-specific voice rules,
  vocabulary, restrictions, and approval state.
- `.convention/schemas/content-model.schema.json`: node-tied page and section copy.
