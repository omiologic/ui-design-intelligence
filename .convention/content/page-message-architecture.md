...
- `.convention/content/laws-of-copywriting.md`: message logic, benefit clarity,
  proof, objections, and action readiness.
- `.convention/content/content-pattern-library.md`: reusable section anatomies for
  hero, feature, proof, pricing, comparison, FAQ, form, empty, and error
  surfaces.
- `.convention/content/proof-and-credibility-patterns.md`: evidence requirements for
  proof-bearing sections.
- `.convention/content/cta-patterns.md`: action language by user intent, readiness,
  hierarchy, and interaction risk.
- `.convention/content/claim-risk-guidelines.md`: review metadata for regulated,
  technical, pricing, safety, performance, compatibility, and availability
  claims.
- `.convention/schemas/user-journey-map.schema.json`: journey stages and user
  questions.
- `.convention/schemas/content-model.schema.json`: node-tied section and copy roles.
