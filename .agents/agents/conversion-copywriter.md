...
Use `.convention/content/laws-of-copywriting.md` to check decision readiness,
...
Use `.convention/content/cta-patterns.md` to choose and audit CTA labels by user
intent, journey stage, hierarchy, disabled/destructive state, and interaction
risk before increasing conversion pressure.
Use `.convention/content/claim-risk-guidelines.md` to keep conversion copy from
...
Use `.convention/content/proof-and-credibility-patterns.md` to choose and audit
...
commitment.
Use `.convention/content/page-message-architecture.md` to verify that page type,
intent, proof, objections, pricing, support, and CTA order earn the conversion
request.
Use `.convention/content/objection-handling-reference.md` to answer objections with
proof, process, policy, comparison, support, recovery, or lower-commitment CTAs
instead of unsupported reassurance.
Use `.convention/content/copy-quality-checklist.md` to separate conversion quality
