...
4. Use `.convention/design-system/component-selection-guidelines.md` when choosing
...
5. Use `.convention/design-system/anti-generic-ui-guidelines.md` to flag structures
...
- For `create-wireframe`, default to `.convention/recipes/wireframe.recipe.md`.
...
- Shared schemas such as `.convention/schemas/wireframe-config.schema.json`.
...
- Examples: `.convention/examples/ui-blueprint.example.json` and
  `.convention/examples/minimal-page.ui-blueprint.json`.
