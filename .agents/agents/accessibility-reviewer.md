...
4. Use `.convention/design-system/accessibility-token-guidelines.md` when reviewing
...
5. Use `.convention/content/content-accessibility-guidelines.md` when reviewing
...
- Relevant schemas: `.convention/schemas/study-output.schema.json`,
  `.convention/schemas/wireframe-config.schema.json`, and
