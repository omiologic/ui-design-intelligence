...
2. Run `study-ui-interaction` for triggers, states, overlays, dismissal, forms,
   and feedback.
3. Use `.convention/design-system/component-state-guidelines.md` to normalize
...
- States are normalized through
  `.convention/design-system/component-state-guidelines.md` and
...
- Optional prototype schemas from `.convention/schemas/prototype-config.schema.json`
  and `.convention/schemas/interaction-flow.schema.json`.
