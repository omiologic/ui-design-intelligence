...
2. Use `.convention/design-system/token-taxonomy.md` for token category and naming
   decisions.
3. Use `.convention/design-system/component-anatomy-reference.md` for component
   slots, required parts, content hooks, accessibility hooks, and state hooks.
4. Use `.convention/design-system/component-state-guidelines.md` for reusable state
   expectations before prototype-specific transitions are modeled.
5. Use `.convention/design-system/accessibility-token-guidelines.md` for contrast,
   focus, target size, readable type, reduced motion, disabled legibility, and
   non-color state constraints.
6. Use `.convention/design-system/responsive-system-guidelines.md` for responsive
   token, component, density, sticky region, and handoff expectations.
7. Use `.convention/design-system/visual-style-calibration.md` to translate style
   ...
   decisions.
8. Use `.convention/design-system/component-selection-guidelines.md` when seed
   ...
   disclosure.
9. Use `.convention/design-system/anti-generic-ui-guidelines.md` to flag one-note
...
14. Use `.convention/design-system/design-system-quality-checklist.md` to assign
   draft, review-ready, or implementation-ready seed readiness.
15. Use `.convention/design-system/design-system-handoff-checklist.md` before
...
- For `create-design-spec`, default to `.convention/recipes/design-spec.recipe.md`.
...
- Style calibration follows `.convention/design-system/visual-style-calibration.md`
...
- Generic design-system decisions are checked against
  `.convention/design-system/anti-generic-ui-guidelines.md`.
- Token categories and names follow `.convention/design-system/token-taxonomy.md`.
- Design-system seed readiness is checked against
  `.convention/design-system/design-system-quality-checklist.md`.
- Design-system handoff readiness is checked against
  `.convention/design-system/design-system-handoff-checklist.md` when a seed leaves
...
- Shared schemas such as `.convention/schemas/design-system-seed.schema.json` and
  `.convention/schemas/runtime-design-theme.schema.json` and foundation schemas.
- Foundation schemas include `.convention/schemas/brand-foundation.schema.json`,
  `.convention/schemas/palette-foundation.schema.json`, and
  `.convention/schemas/typography-foundation.schema.json`.
...
- Templates: `.convention/templates/design-system-seed.json` and
