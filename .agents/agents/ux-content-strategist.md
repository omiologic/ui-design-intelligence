...
3. Use `.convention/design-system/component-anatomy-reference.md` to map copy jobs
...
Use `.convention/content/laws-of-copywriting.md` to plan decision sequence,
...
Use `.convention/content/content-pattern-library.md` to translate journey stages
...
Use `.convention/content/page-message-architecture.md` to choose the message
...
Use `.convention/content/audience-intent-reference.md` to map awareness, readiness,
and emotional state to copy depth, proof needs, CTA posture, microcopy needs,
and tone restraint.
Use `.convention/content/objection-handling-reference.md` to map price, trust,
...
support copy.
Use `.convention/content/proof-and-credibility-patterns.md` to name the proof type
...
- Brief, study findings, journey maps, page flows, and optional knowledge
  patterns.
- Shared references: `.convention/content/audience-intent-reference.md`,
...
- Schema references: `.convention/schemas/user-journey-map.schema.json` and
