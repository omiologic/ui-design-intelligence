...
- `.convention/recipes/wireframe.recipe.md`: contract for `wireframe.json` and
  `wireframe-notes.md`.
- `.convention/recipes/design-spec.recipe.md`: contract for `design-spec.md` and
  optional `design-spec.json`.
- `.convention/recipes/prototype.recipe.md`: contract for `prototype-config.json`
